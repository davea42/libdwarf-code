    ...
    Dwarf_Error *err)
{
    ...
    for (;;) {
        ...
        /* Here do pre-descent processing of the die. */
        {
            ...
            if (!print_as_info_or_cu() && an_attribute_match_local) {
    ...
    for (i = 0; i < atcnt; i++) {
        ...
        if (ares == DW_DLV_OK) {
            ...
            }
            {
                ...
                if (print_information == FALSE && attr_match_localb) {
        ...
        if (glflags.gf_check_forward_decl ||
            ...
            if (!suppress_check &&
                ...
                if (frres == DW_DLV_OK) {
                    ...
                    frres = traverse_one_die(dbg,attrib,ref_die,
                        ref_die_cu_goff,
        ...
        if(loclist_source || checking) {
            ...
            if (lle_value == DW_LLEX_base_address_selection_entry) {
                ...
                if (loclist_source == 2) {
                    ...
                    esb_append(esbp,
                        "<ERROR: Impossible start-end entry>");
                    glflags.gf_count_major_errors++;
                    /* Impossible */
                }
                if (checking && foundaddr) {
