...
#define DW_FISSION_SECT_COUNT 9
/*  User must allocate this struct and pass a pointer to it
...
struct Dwarf_Debug_Fission_Per_CU_s  {
    ...
    /*  [0] has offset and size 0.
        ...
        values below are  the offset and size
        of the respective section contribution
        of a single .dwo object. When pcu_sizes[n] is
